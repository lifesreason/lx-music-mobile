...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(236, 65, 65)",
        "c-primary-dark-100": "rgb(212,59,59)",
        "c-primary-dark-100-alpha-100": "rgba(212, 59, 59, 0.90)",
        "c-primary-alpha-100": "rgba(236, 65, 65, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(212, 59, 59, 0.80)",
        "c-primary-alpha-200": "rgba(236, 65, 65, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(212, 59, 59, 0.70)",
        "c-primary-alpha-300": "rgba(236, 65, 65, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(212, 59, 59, 0.60)",
        "c-primary-alpha-400": "rgba(236, 65, 65, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(212, 59, 59, 0.50)",
        "c-primary-alpha-500": "rgba(236, 65, 65, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(212, 59, 59, 0.40)",
        "c-primary-alpha-600": "rgba(236, 65, 65, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(212, 59, 59, 0.30)",
        "c-primary-alpha-700": "rgba(236, 65, 65, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(212, 59, 59, 0.20)",
        "c-primary-alpha-800": "rgba(236, 65, 65, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(212, 59, 59, 0.10)",
        "c-primary-alpha-900": "rgba(236, 65, 65, 0.10)",
        "c-primary-dark-200": "rgb(191,53,53)",
        "c-primary-dark-200-alpha-100": "rgba(191, 53, 53, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(191, 53, 53, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(191, 53, 53, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(191, 53, 53, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(191, 53, 53, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(191, 53, 53, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(191, 53, 53, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(191, 53, 53, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(191, 53, 53, 0.10)",
        "c-primary-dark-300": "rgb(172,48,48)",
        "c-primary-dark-300-alpha-100": "rgba(172, 48, 48, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(172, 48, 48, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(172, 48, 48, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(172, 48, 48, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(172, 48, 48, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(172, 48, 48, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(172, 48, 48, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(172, 48, 48, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(172, 48, 48, 0.10)",
        "c-primary-dark-400": "rgb(155,43,43)",
        "c-primary-dark-400-alpha-100": "rgba(155, 43, 43, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(155, 43, 43, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(155, 43, 43, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(155, 43, 43, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(155, 43, 43, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(155, 43, 43, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(155, 43, 43, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(155, 43, 43, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(155, 43, 43, 0.10)",
        "c-primary-dark-500": "rgb(140,39,39)",
        "c-primary-dark-500-alpha-100": "rgba(140, 39, 39, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(140, 39, 39, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(140, 39, 39, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(140, 39, 39, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(140, 39, 39, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(140, 39, 39, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(140, 39, 39, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(140, 39, 39, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(140, 39, 39, 0.10)",
        "c-primary-dark-600": "rgb(126,35,35)",
        "c-primary-dark-600-alpha-100": "rgba(126, 35, 35, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(126, 35, 35, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(126, 35, 35, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(126, 35, 35, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(126, 35, 35, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(126, 35, 35, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(126, 35, 35, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(126, 35, 35, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(126, 35, 35, 0.10)",
        "c-primary-dark-700": "rgb(113,32,32)",
        "c-primary-dark-700-alpha-100": "rgba(113, 32, 32, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(113, 32, 32, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(113, 32, 32, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(113, 32, 32, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(113, 32, 32, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(113, 32, 32, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(113, 32, 32, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(113, 32, 32, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(113, 32, 32, 0.10)",
        "c-primary-dark-800": "rgb(102,29,29)",
        "c-primary-dark-800-alpha-100": "rgba(102, 29, 29, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(102, 29, 29, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(102, 29, 29, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(102, 29, 29, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(102, 29, 29, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(102, 29, 29, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(102, 29, 29, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(102, 29, 29, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(102, 29, 29, 0.10)",
        "c-primary-dark-900": "rgb(92,26,26)",
        "c-primary-dark-900-alpha-100": "rgba(92, 26, 26, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(92, 26, 26, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(92, 26, 26, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(92, 26, 26, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(92, 26, 26, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(92, 26, 26, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(92, 26, 26, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(92, 26, 26, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(92, 26, 26, 0.10)",
        "c-primary-dark-1000": "rgb(83,23,23)",
        "c-primary-dark-1000-alpha-100": "rgba(83, 23, 23, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(83, 23, 23, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(83, 23, 23, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(83, 23, 23, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(83, 23, 23, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(83, 23, 23, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(83, 23, 23, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(83, 23, 23, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(83, 23, 23, 0.10)",
        "c-primary-light-100": "rgb(240,103,103)",
        "c-primary-light-100-alpha-100": "rgba(240, 103, 103, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(240, 103, 103, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(240, 103, 103, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(240, 103, 103, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(240, 103, 103, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(240, 103, 103, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(240, 103, 103, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(240, 103, 103, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(240, 103, 103, 0.10)",
        "c-primary-light-200": "rgb(243,133,133)",
        "c-primary-light-200-alpha-100": "rgba(243, 133, 133, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(243, 133, 133, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(243, 133, 133, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(243, 133, 133, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(243, 133, 133, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(243, 133, 133, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(243, 133, 133, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(243, 133, 133, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(243, 133, 133, 0.10)",
        "c-primary-light-300": "rgb(245,157,157)",
        "c-primary-light-300-alpha-100": "rgba(245, 157, 157, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(245, 157, 157, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(245, 157, 157, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(245, 157, 157, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(245, 157, 157, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(245, 157, 157, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(245, 157, 157, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(245, 157, 157, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(245, 157, 157, 0.10)",
        "c-primary-light-400": "rgb(247,177,177)",
        "c-primary-light-400-alpha-100": "rgba(247, 177, 177, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(247, 177, 177, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(247, 177, 177, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(247, 177, 177, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(247, 177, 177, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(247, 177, 177, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(247, 177, 177, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(247, 177, 177, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(247, 177, 177, 0.10)",
        "c-primary-light-500": "rgb(249,193,193)",
        "c-primary-light-500-alpha-100": "rgba(249, 193, 193, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(249, 193, 193, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(249, 193, 193, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(249, 193, 193, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(249, 193, 193, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(249, 193, 193, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(249, 193, 193, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(249, 193, 193, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(249, 193, 193, 0.10)",
        "c-primary-light-600": "rgb(250,205,205)",
        "c-primary-light-600-alpha-100": "rgba(250, 205, 205, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(250, 205, 205, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(250, 205, 205, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(250, 205, 205, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(250, 205, 205, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(250, 205, 205, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(250, 205, 205, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(250, 205, 205, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(250, 205, 205, 0.10)",
        "c-primary-light-700": "rgb(251,215,215)",
        "c-primary-light-700-alpha-100": "rgba(251, 215, 215, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(251, 215, 215, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(251, 215, 215, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(251, 215, 215, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(251, 215, 215, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(251, 215, 215, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(251, 215, 215, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(251, 215, 215, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(251, 215, 215, 0.10)",
        "c-primary-light-800": "rgb(252,223,223)",
        "c-primary-light-800-alpha-100": "rgba(252, 223, 223, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(252, 223, 223, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(252, 223, 223, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(252, 223, 223, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(252, 223, 223, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(252, 223, 223, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(252, 223, 223, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(252, 223, 223, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(252, 223, 223, 0.10)",
        "c-primary-light-900": "rgb(253,229,229)",
        "c-primary-light-900-alpha-100": "rgba(253, 229, 229, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(253, 229, 229, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(253, 229, 229, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(253, 229, 229, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(253, 229, 229, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(253, 229, 229, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(253, 229, 229, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(253, 229, 229, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(253, 229, 229, 0.10)",
        ...
        "c-600": "rgb(121,121,121)",
        "c-550": "rgb(132,132,132)",
